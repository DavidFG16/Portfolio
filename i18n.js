...
const translations = {
  en: {
    ...
    expQuiltRole: 'Junior DevOps Engineer',
    expQuiltTime: 'April 2026 — Present',
    expGlobantRole: 'DevOps Trainee',
    expGlobantTime: 'April 2025 — April 2026',
  ...
  es: {
    ...
    expQuiltRole: 'Junior DevOps Engineer',
    expQuiltTime: 'Abril 2026 — Presente',
    expGlobantRole: 'Practicante DevOps',
    expGlobantTime: 'Abril 2025 — Abril 2026',
